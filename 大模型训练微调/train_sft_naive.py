...
class CustomModelArguments(ModelArguments):
    ...
    model_name_or_path: Optional[str] = field(default="/njfs/train-nlp/huipeng6/weights/Qwen2.5-32B-Instruct")


@dataclass
class CustomDataArguments(DataTrainingArguments):
    dataset_name: str = field(default="/data0/zejun7/open_source/bilibili_code/大模型训练微调/data/sky_original_dataset_0419.json", metadata={"help": "数据集路径"})
...
class CustomTrainingArguments(TrainingArguments):
    ...
    output_dir: str = field(default="save/cloud_sft1_full_0419", metadata={"help": "模型权重保存路径"})
    ...
    deepspeed: Optional[Union[dict, str]] = field(default='deepspeed/ds_z3_offload_config.json', metadata={"help": "deepspeed配置文件路径，或已加载json的字典"})
...
CUDA_VISIBLE_DEVICES=0,1,2,3 deepspeed --num_gpus=4 train_sft_naive.py
'''
